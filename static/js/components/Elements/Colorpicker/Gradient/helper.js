...
export const parseGradient = (str) => {
  const defaultStops = {
    ...
    gradient: 'linear-gradient(180deg, rgba(0, 0, 0, 1) 0.0%,rgba(183, 80, 174, 0.92) 100.0%)',
    modifier: 180,
    type: 'linear',
  };
  ...
  if (isValidHex(str)) {
    ...
    if (rgbaArr) {
      ...
      defaultStops.gradient = `linear-gradient(180deg, rgba(0, 0, 0, 1) 0.0%,rgba(${rgbaArr[0]}, ${rgbaArr[1]}, ${rgbaArr[2]}, 1) 100.0%)`;
    }
